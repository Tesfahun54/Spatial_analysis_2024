...
id <- which(str_detect(string = files_phen$studyName, pattern = "GP502_2022"))
Phen_sel <- files_phen[id,]


methods = c("Block", "Block+Spatial", "Block+Marker", "Block+Marker+Spatial")

Traits <- c("Grain.yield...kg.ha.CO_321.0001218", "Plant.height...cm.CO_321.0001301", "Grain.test.weight...g.l.CO_321.0001210")
